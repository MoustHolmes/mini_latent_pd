...
# Only define the kernel if Triton is available
if HAS_TRITON:
    @triton.autotune(
...
if HAS_TRITON:
    @triton.testing.perf_report(
        triton.testing.Benchmark(
            ...
            line_arg="provider",
            line_vals=["torch", "torch-compile", "triton"],
            line_names=["Torch", "Torch-compile", "Triton"],
    ...
    # Dummy function to prevent NameError if called
    def benchmark(*args, **kwargs):
        print("Triton is not available on this system.")
